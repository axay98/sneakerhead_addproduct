...
import Sale2Comp from "../components/ui/Sale2Comp";
import { useState, useEffect } from "react";

import { Sale20Endpoint, authEndpoint } from "./Property.js";
...
export async function getServerSideProps() {
  ...
  const res = await fetch(Sale20Endpoint, {
    method: "GET",
    headers: {
...
function SaleTwentyPercent({ data }) {
  ...
  return (
    <div>
      <InstantSearch searchClient={searchClient} indexName={algoliaindex}>
        ...
        <Sale2Comp value={results} />
      </InstantSearch>
    </div>
  );
}

export default SaleTwentyPercent;
