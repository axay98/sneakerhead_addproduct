...
import Shoe3Comp from "../components/ui/Shoe3Comp";
import { useState, useEffect } from "react";

import { ReebokEndpoint, authEndpoint } from "./Property.js";
...
export async function getServerSideProps() {
  ...
  const res = await fetch(ReebokEndpoint, {
    method: "GET",
    headers: {
